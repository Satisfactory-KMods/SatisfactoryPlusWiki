...
<template>
	<div class="flex w-full flex-col gap-2 py-2">
		<NuxtLink
			...
			class="flex cursor-pointer gap-2 rounded border bg-gray-50 p-2 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 hover:dark:bg-gray-900">
			<NuxtImg
			...
			<div class="flex flex-1 flex-col gap-1">
				<div class="flex flex-col gap-1">
					<div class="text-lg font-bold">{{ schematic.name }}</div>
